...
public class RCompraAccionesA extends ingenias.editor.entities.RuntimeFact{
  ...
  public RCompraAccionesA (String id){
   super(id);
   this.getPrefs().setView(ViewType.UML);
   this.type="RCompraAccionesA";
  }
  

  public RCompraAccionesA (){
