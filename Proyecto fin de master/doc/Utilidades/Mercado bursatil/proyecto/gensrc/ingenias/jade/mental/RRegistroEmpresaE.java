...
public class RRegistroEmpresaE extends ingenias.editor.entities.RuntimeFact{
  ...
  public RRegistroEmpresaE (String id){
   super(id);
   this.getPrefs().setView(ViewType.UML);
   this.type="RRegistroEmpresaE";
  }
  

  public RRegistroEmpresaE (){
