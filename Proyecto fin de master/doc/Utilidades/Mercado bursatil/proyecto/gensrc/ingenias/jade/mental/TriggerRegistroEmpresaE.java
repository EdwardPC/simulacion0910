...
public class TriggerRegistroEmpresaE extends ingenias.editor.entities.RuntimeFact{
  ...
  public TriggerRegistroEmpresaE (String id){
   super(id);
   this.getPrefs().setView(ViewType.UML);
   this.type="TriggerRegistroEmpresaE";
  }
  

  public TriggerRegistroEmpresaE (){
  ...
  public String getType(){
   return "TriggerRegistroEmpresaE";
  }
