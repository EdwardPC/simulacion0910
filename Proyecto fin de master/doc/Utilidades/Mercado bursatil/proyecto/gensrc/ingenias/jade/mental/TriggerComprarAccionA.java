...
public class TriggerComprarAccionA extends ingenias.editor.entities.RuntimeFact{
  ...
  public TriggerComprarAccionA (String id){
   super(id);
   this.getPrefs().setView(ViewType.UML);
   this.type="TriggerComprarAccionA";
  }
  

  public TriggerComprarAccionA (){
