...
public class TriggerVentaAccionA extends ingenias.editor.entities.RuntimeFact{
  ...
  public TriggerVentaAccionA (String id){
   super(id);
   this.getPrefs().setView(ViewType.UML);
   this.type="TriggerVentaAccionA";
  }
  

  public TriggerVentaAccionA (){
