...
public class RObtenerInformacionA extends ingenias.editor.entities.RuntimeFact{
   
    java.lang.String IdAccionista;   
    
   
  public RObtenerInformacionA (String id){
   super(id);
   this.getPrefs().setView(ViewType.UML);
   this.type="RObtenerInformacionA";
  }
  

  public RObtenerInformacionA (){
