...
public class AVentaAccionesB extends ingenias.editor.entities.RuntimeFact{
  ...
  public AVentaAccionesB (String id){
   super(id);
   this.getPrefs().setView(ViewType.UML);
   this.type="AVentaAccionesB";
  }
  

  public AVentaAccionesB (){
