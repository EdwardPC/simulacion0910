...
public class RVentaAccionesA extends ingenias.editor.entities.RuntimeFact{
  ...
  public RVentaAccionesA (String id){
   super(id);
   this.getPrefs().setView(ViewType.UML);
   this.type="RVentaAccionesA";
  }
  

  public RVentaAccionesA (){
