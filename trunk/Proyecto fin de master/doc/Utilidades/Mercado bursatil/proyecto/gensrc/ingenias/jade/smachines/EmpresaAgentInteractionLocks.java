...
*/
			...
			public class EmpresaAgentInteractionLocks implements CustomLocks {
			
			public EmpresaAgentInteractionLocks(){};
                  ...
                  if (interaction.equals("IRegistroEmpresa")&& role.equals("Empresa")){
                    EmpresaIRegistroEmpresaDefaultCommControl.addDefaultLocks(lw);
                  }
