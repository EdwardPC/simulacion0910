...
*/
			...
			public class AccionistaAgentInteractionLocks implements CustomLocks {
			
			public AccionistaAgentInteractionLocks(){};
                  ...
                  if (interaction.equals("IObtenerInformacion")&& role.equals("Accionista")){
                    AccionistaIObtenerInformacionDefaultCommControl.addDefaultLocks(lw);
                  }
				  
                  if (interaction.equals("IVentaAcciones")&& role.equals("Accionista")){
                    AccionistaIVentaAccionesDefaultCommControl.addDefaultLocks(lw);
                  }
				  
                  if (interaction.equals("IComprarAcciones")&& role.equals("Accionista")){
                    AccionistaIComprarAccionesDefaultCommControl.addDefaultLocks(lw);
                  }
