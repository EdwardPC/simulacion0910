...
public class EventVentaAcciones extends ingenias.editor.entities.RuntimeEvent{
   ...
   public EventVentaAcciones (String id){
   super(id);
   this.getPrefs().setView(ViewType.UML);
   this.type="EventVentaAcciones";
  }
  

  public EventVentaAcciones (){
